                    ...
                    <div class="page-header">
                        ...
                        <c:choose>
                            <c:when test="${sessionScope.user.role.id == 3}">
                                <a href="${pageContext.request.contextPath}/goods-issue?action=list" class="btn-back">
                                    <i class="ri-arrow-left-line"></i> Back to Warehouse List
                                </a>
                            </c:when>
                            <c:otherwise>
                                <a href="${pageContext.request.contextPath}/sales-order?action=list" class="btn-back">
                                    <i class="ri-arrow-left-line"></i> Back to Sales List
                                </a>
                            </c:otherwise>
                        </c:choose>
                    </div>
