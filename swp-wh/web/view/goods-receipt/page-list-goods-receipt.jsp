                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <div class="header-title">
                                <h4 class="card-title"><i
                                        class="fas fa-clipboard-check mr-2"></i>Goods Receipt Order List</h4>
                            </div>
                            <a href="${pageContext.request.contextPath}/create-goods-receipt"
                               class="btn btn-primary">
                                <i class="fas fa-plus mr-1"></i> Create New GRO
                            </a>
                        </div>
                        <div class="card-body">
                            <form method="get"
                            ...
                            <p class="text-muted text-center">Total: <strong>${total}</strong> receipts
                            </p>
                        </div>
                    </div>
                </div>
