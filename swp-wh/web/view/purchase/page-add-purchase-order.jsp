                            ...
                            <c:choose>
                                <c:when test="${empty detailOptions}">
                                    <p class="text-center text-warning py-3 mb-0">
                                        No variants (details) found for this supplier's products. Please create products and details in the inventory module first.
                                    </p>
                                </c:when>
                                <c:otherwise>
                                            ...
                                            <div class="row align-items-end">
                                                    ...
                                                    <select name="productDetailId" class="form-control variant-select" required
                                                        ...
                                                        <c:forEach var="opt" items="${detailOptions}">
                                                            <option value="${opt.id}"
                                                                ...
                                                                data-price="<fmt:formatNumber value="${opt.price}" groupingUsed="false" maxFractionDigits="2" />"
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="text" name="price" class="form-control"
                                                           value="<c:if test='${line.price != null}'><fmt:formatNumber value='${line.price}' groupingUsed='false' maxFractionDigits='2' /></c:if>" min="0" required
