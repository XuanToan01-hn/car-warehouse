                                    ...
                                    <form action="${pageContext.request.contextPath}/add-purchase-order" method="post"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="orderCode" id="orderCode"
                                                                ...
                                                                placeholder="PO-YYYYMMDD-NNNN" required>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <small class="text-muted">Select a supplier then click
                                                                <strong>Apply</strong> to load products /
                                                                variants.</small>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="d-flex justify-content-between mb-4">
                                            ...
                                            <c:if test="${draft.supplierId gt 0 and not empty detailOptions}">
                                                <button type="submit" name="createPO" value="1"
