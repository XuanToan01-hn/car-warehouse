                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="search" class="form-control"
                                                    style="border-radius: 10px;" placeholder="Order code, supplier..."
                                                    value="${search}">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <tbody>
                                            <c:forEach var="po" items="${poList}" varStatus="st">
                                                <tr>
                                                    ...
                                                    <td><span
                                                            class="text-primary font-weight-bold">${po.orderCode}</span>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <c:choose>
                                                            <c:when test="${po.status == 1}"><span
                                                                    class="badge badge-warning badge-status">DRAFT</span>
                                                            </c:when>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="text-primary font-weight-bold">${po.orderedQty}</span>
                                                        <span class="mx-1 text-secondary">/</span>
                                                        <span
                                                            class="text-success font-weight-bold">${po.receivedQty}</span>
                                                    </td>
                                            ...
                                            <c:if test="${empty poList}">
                                                <tr>
                                                    <td colspan="8" class="text-center text-muted py-5">No purchase
                                                        orders found.</td>
                                                </tr>
                                            </c:if>
                                        </tbody>
                                    ...
                                    <nav class="mt-4">
                                        <ul class="pagination justify-content-center">
                                            <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                                                <a class="page-link"
                                                    href="?search=${search}&status=${statusFilter}&page=${currentPage - 1}">&laquo;</a>
                                            </li>
                                            ...
                                            <li class="page-item ${currentPage == totalPages ? 'disabled' : ''}">
                                                <a class="page-link"
                                                    href="?search=${search}&status=${statusFilter}&page=${currentPage + 1}">&raquo;</a>
                                            </li>
                                        </ul>
                                    </nav>
                                </c:if>
