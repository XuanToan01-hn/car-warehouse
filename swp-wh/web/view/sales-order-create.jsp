                        ...
                        <div class="card card-form">
                            <form action="sales-order" method="post" id="orderForm">
                                ...
                                <c:if test="${not empty inventoryErrors}">
                                    <div style="background-color: #fee2e2; border: 1px solid #ef4444; color: #b91c1c; padding: 1rem; border-radius: 8px; margin-bottom: 1.5rem;">
                                        <h4 style="margin-top: 0; margin-bottom: 0.5rem; font-weight: bold;">Lỗi tồn kho:</h4>
