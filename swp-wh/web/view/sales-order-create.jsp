                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="note" class="form-control" rows="2" placeholder="Additional instructions..."></textarea>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="row mb-3 border-bottom pb-3 item-row">
                ...
                <div class="form-group">
                    ...
                    <select name="productDetailId" class="form-control product-detail-select" onchange="updateRowInfo(this)" required disabled>
                        ...
                        <c:forEach var="pd" items="${allDetails}">
                            <option value="${pd.id}" 
                                    data-product="${pd.product.id}" 
                                    data-price="${pd.price}" 
                                    data-stock="${pd.quantity}"
                                    style="display:none;">
            ...
            <div class="col-md-1">
                <div class="form-group">
                    ...
                    <button type="button" class="btn btn-outline-danger btn-block btn-sm" onclick="this.closest('.row').remove()">
