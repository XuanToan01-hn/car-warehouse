                                            ...
                                            <%-- Error inside form --%>
                                                ...
                                                <form action="locations" method="post">
                                                    ...
                                                    <div class="text-right mt-2">
                                                        ...
                                                        <button type="submit" class="btn btn-add ml-2 px-4 py-2">Save
                                                            Location</button>
                                                    </div>
                                                </form>
                                        </div>
                                                        ...
                                                        <table class="table mb-0">
                                                            ...
                                                            <tbody>
                                                                <c:forEach var="l" items="${locations}">
                                                                    <tr>
                                                                        <td><span
                                                                                class="font-weight-bold text-primary">${l.locationCode}</span>
                                                                        </td>
                                                                        <td><span
                                                                        ...
                                                                        <td class="text-center">
                                                                            <span
                                                                                class="badge badge-soft-success px-3 py-2">${l.currentStock}</span>
                                                                        </td>
                                                                        <td class="text-right">
                                                                            ...
                                                                            <c:if
                                                                                test="${sessionScope.user.role.id == 2}">
