...
<head>
    ...
    <title>Issue Confirmation | InventoryPro</title>
    ...
    <style>
        .table-input { width: 85px; padding: 5px; border: 1px solid #ced4da; border-radius: 4px; text-align: center; }
        .stock-badge { font-weight: 600; padding: 4px 10px; border-radius: 4px; font-size: 0.85rem; }
                        ...
                        <div class="card card-block card-stretch card-height">
                            <div class="card-header d-flex justify-content-between">
                                <div class="header-title">
                                    <h4 class="card-title">Issue Confirmation: <span class="text-primary">${order.orderCode}</span></h4>
                                    <p class="mb-0 small text-muted">Select pick location and enter actual ship quantities for each item.</p>
                                </div>
                                <div class="card-header-toolbar d-flex align-items-center">
                                    <a href="goods-issue" class="btn btn-light">Back</a>
                                </div>
                            </div>
                                    ...
                                    <div class="row mb-4 p-3 bg-light rounded">
                                        <div class="col-md-5">
                                            <div class="form-group mb-0">
                                                <label class="select-label">Warehouse (Assigned):</label>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group mb-0">
                                                <label class="select-label">Pick Location (Bin):</label>
                                        ...
                                        <table class="table table-hover table-bordered mb-0">
                                            <thead class="bg-primary text-white">
                                                <tr>
                                                    ...
                                                    <th class="text-center">In Stock (Loc)</th>
                                                    <th class="text-center" style="width: 160px;">Ship Quantity</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <div class="small text-muted">
                                                                    Color: ${row[7]} | Lot/Serial: <span class="badge badge-info">${row[1]}</span>
                                                                </div>
                                                            ...
                                                            <td class="text-center">
                                                                <input type="number" name="shipQty" class="table-input" min="0" 
                                                                       max="${row[5] < row[4] ? row[5] : row[4]}" value="0">
                                                            </td>
                                                        </tr>
                                                    </c:if>
                                                </c:forEach>
                                                <c:if test="${!hasItems}">
                                                    <tr>
                                                        <td colspan="6" class="text-center p-4">
                                                            <p class="mb-0">This order is fully shipped or has no pending items.</p>
                                                        </td>
                                                    </tr>
                                                </c:if>
                                            </tbody>
