<%-- Document : page-update-product Created on : Mar 2, 2026, 10:33:26 PM Author : Asus --%>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 form-group">
                                                        <label>Product Name * <span
                                                                style="color:red">${eName}</span></label>
                                                        <input type="text" name="name" value="${p.name}"
                                                            class="form-control" required>
                                                    </div>
                                                    <div class="col-md-6 form-group">
                                                        <label>Product Code * <span
                                                                style="color:red">${eCode}</span></label>
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        ...
                                                        <select name="supplier" class="form-control" required>
                                                            <c:forEach items="${listSupplier}" var="s">
                                                                <option ${p.supplier.id==s.id ? 'selected' : '' }
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        ...
                                                        <select name="category" class="form-control">
                                                            <c:forEach items="${listCategory}" var="c">
                                                                <option ${p.category.id==c.id ? 'selected' : '' }
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        ...
                                                        <select name="unit" class="form-control">
                                                            <c:forEach items="${listUnit}" var="unit">
                                                                <option ${p.unit.id==unit.id ? 'selected' : '' }
