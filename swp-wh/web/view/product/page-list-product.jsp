                            ...
                            <div class="container-fluid">
                                <div class="page-header">
                                    <div>
                                        ...
                                        <p class="text-secondary">Manage your inventory products, categories and
                                            suppliers</p>
                                    </div>
                                            ...
                                            <div class="col-md-3 mb-3 mb-md-0">
                                                ...
                                                <select name="supplierId" class="form-control form-control-modern"
                                                    ...
                                                    <c:forEach items="${listSupplier}" var="s">
                                                        <option value="${s.id}" ${param.supplierId==s.id ? 'selected'
                                                            : '' }>${s.name}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    <img src="${p.image}" class="product-img mr-3"
                                                            ...
                                                            <td>${p.unit.name}</td>
                                                            <td><span
                                                                    class="text-info font-weight-bold">${p.supplier.name}</span>
                                                            </td>
                                                            <td class="text-right">
                                        ...
                                        <ul class="pagination mb-0">
                                            <c:if test="${hasPrevious}">
                                                <li class="page-item"><a class="page-link"
                                                        href="list-product?page=${currentPage - 1}&search=${param.search}&categoryId=${param.categoryId}&supplierId=${param.supplierId}">Previous</a>
                                                </li>
                                            </c:if>
                                            <c:forEach var="i" begin="${startPage}" end="${endPage}">
                                                <li class="page-item ${i == currentPage ? 'active' : ''}"><a
                                                        class="page-link"
                                                        href="list-product?page=${i}&search=${param.search}&categoryId=${param.categoryId}&supplierId=${param.supplierId}">${i}</a>
                                                </li>
                                            </c:forEach>
                                            <c:if test="${hasNext}">
                                                <li class="page-item"><a class="page-link"
                                                        href="list-product?page=${currentPage + 1}&search=${param.search}&categoryId=${param.categoryId}&supplierId=${param.supplierId}">Next</a>
                                                </li>
                                            </c:if>
                                        </ul>
                                    </c:if>
