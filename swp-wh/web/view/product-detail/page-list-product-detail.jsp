                                            ...
                                            <div class="row align-items-end">
                                                <div class="col-md-3">
                                                    ...
                                                    <select name="productId" class="form-control"
                                                        ...
                                                        <c:forEach items="${listProduct}" var="pro">
                                                            <option value="${pro.id}" ${param.productId==pro.id
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" name="search" class="form-control"
                                                        placeholder="Lot or Serial..." value="${param.search}">
                                                </div>
                                                <div class="col-md-2">
                                        ...
                                        <tbody>
                                            <c:forEach items="${listDetail}" var="pd">
                                                <tr>
                                                    ...
                                                    <td><strong>
                                                            <fmt:formatNumber value="${pd.price}" type="currency"
                                                                currencySymbol="$" />
                                                        </strong></td>
                                                    <td>
                                                        <fmt:formatDate value="${pd.manufactureDate}"
                                                            pattern="dd/MM/yyyy" />
                                                    </td>
                                                    <td class="text-right">
                                                        <a href="edit-product-detail?id=${pd.id}"
                                                            class="btn btn-sm btn-outline-primary">Edit</a>
                                                        <a href="list-product-detail?action=delete&id=${pd.id}"
                                            ...
                                            <c:if test="${empty listDetail}">
                                                <tr>
                                                    <td colspan="7" class="text-center text-muted">No product detail
                                                        found.</td>
                                                </tr>
                                            </c:if>
                                        </tbody>
                                ...
                                <nav class="mt-3">
                                    <ul class="pagination justify-content-end">
                                        <c:if test="${currentPage > 1}">
                                            <li class="page-item">
                                                <a class="page-link"
                                                    href="list-product-detail?page=${currentPage - 1}&productId=${param.productId}&search=${param.search}">Previous</a>
                                            </li>
                                        </c:if>
                                        ...
                                        <c:if test="${currentPage < totalPages}">
                                            <li class="page-item">
                                                <a class="page-link"
                                                    href="list-product-detail?page=${currentPage + 1}&productId=${param.productId}&search=${param.search}">Next</a>
                                            </li>
                                        </c:if>
                                    </ul>
                                </nav>
