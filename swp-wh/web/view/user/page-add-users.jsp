                                ...
                                <div class="card-body">
                                    ...
                                    <form action="registeruser" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label font-weight-bold">Staff Code *</label>
                                                    <input type="text" class="form-control" name="userCode" value="${userCode}" placeholder="Enter staff code" required>
