...
public class WarehouseTransferServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<TransferOrder> transfers = transferDAO.getTransfersPaged(code, status, warehouseId, type, page, pageSize);
        int totalTransfers = transferDAO.getTransfersCount(code, status, warehouseId, type);
