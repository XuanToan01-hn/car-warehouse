 ...
 * @author LEGION
 */
@WebServlet(name = "ResetPasswordAdminServlet", urlPatterns = {"/resetpassadmin"})
public class ResetPasswordAdminServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ResetPasswordAdminServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ResetPasswordAdminServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!newPassword.equals(confirmPassword)) {
                session.setAttribute("error", "Password confirmation does not match!");
            ...
            boolean success = userService.updatePasswordByAmdin(userId, passwordEncoding);
